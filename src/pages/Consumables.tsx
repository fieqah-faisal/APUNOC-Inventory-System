...
import { items as initialItems, categories } from '../data/mockData';
...
const Consumables: React.FC = () => {
  ...
  const isLowStock = (item: Item) => item.quantity <= item.minThreshold;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 card-shadow">
        ...
        <p className="text-sm text-gray-600 mt-1">Track cables, connectors, and other consumable items</p>
      </div>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-6 rounded-xl mb-4 border border-indigo-100">
                ...
                <div className="mt-3 pt-3 border-t border-indigo-200">
                  <p className="text-sm text-gray-600">
                    Min Threshold: <span className={`font-semibold ${lowStock ? 'text-amber-600' : 'text-gray-900'}`}>{item.minThreshold}</span>
                  </p>
                </div>
              </div>
